...
spark.sql(f"CREATE VOLUME IF NOT EXISTS {MY_CATALOG}.{MY_SCHEMA}.{MY_VOLUME_STATIC};")
...
print(f"MY_VOLUME_QR: /Volumes/{MY_CATALOG}/{MY_SCHEMA}/{MY_VOLUME_QR}")
print(f"MY_VOLUME_CONTNETS: /Volumes/{MY_CATALOG}/{MY_SCHEMA}/{MY_VOLUME_CONTNETS}")
print(f"MY_VOLUME_STATIC: /Volumes/{MY_CATALOG}/{MY_SCHEMA}/{MY_VOLUME_STATIC}")
print(f"MY_VOLUME_MLFLOW: /Volumes/{MY_CATALOG}/{MY_SCHEMA}/{MY_VOLUME_MLFLOW}")
